...
initial_position_.x = rospy.get_param('robot1_initial_x')
initial_position_.y = rospy.get_param('robot1_initial_y')
initial_position_.z = 0
desired_position_ = Point()
desired_position_.x = rospy.get_param('robot1_des_pos_x')
desired_position_.y = rospy.get_param('robot1_des_pos_y')
...
def main():
    ...
    sub_laser = rospy.Subscriber('robot1/base_scan', LaserScan, clbk_laser)
